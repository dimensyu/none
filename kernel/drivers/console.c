...
extern void cons_print(int cons,const char * buf,cnt_t count){
    ...
    foreach(i,0,count){
        ...
        if(state == 1){
            switch(ch){
                case    'o':attr = (attr & 0xf8) | 0x00;break;  /*! normal !*/
                case    'O':attr = (attr & 0x8f) | 0x00;break;
                case    'b':attr = (attr & 0xf8) | 0x01;break;  /*! blue !*/
                case    'B':attr = (attr & 0x8f) | 0x10;break;
                case    'g':attr = (attr & 0xf8) | 0x02;break;  /*! green !*/
                case    'G':attr = (attr & 0x8f) | 0x20;break;
                case    'y':attr = (attr & 0xf8) | 0x03;break;  /*! yellow !*/
                case    'Y':attr = (attr & 0x8f) | 0x30;break;
                case    'r':attr = (attr & 0xf8) | 0x04;break;  /*! red !*/
                case    'R':attr = (attr & 0x8f) | 0x40;break;
                case    'v':attr = (attr & 0xf8) | 0x05;break;  /*! !*/
                case    'V':attr = (attr & 0x8f) | 0x50;break;
                case    'h':attr = (attr & 0xf8) | 0x06;break;  
                case    'H':attr = (attr & 0x8f) | 0x60;break;  /*! white !*/
                case    'w':attr = (attr & 0xf8) | 0x07;break;
                case    'W':attr = (attr & 0x8f) | 0x70;break;
